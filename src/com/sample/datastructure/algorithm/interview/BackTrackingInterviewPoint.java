...
See image "N*NBackTracking.png" depicting NQueen Problem

=================================Problems=================================
1) WordSearchBackTrackBoggle
2) GenerateParentheses - Double backtracking
3) ReconstructItineraryBackTrack
