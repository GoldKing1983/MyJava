...
/*
1) Given the weights and profits of ‘N’ items, we are asked to put these items in a knapsack which has a capacity ‘C’.
2) The goal is to get the maximum profit from the items in the knapsack.
3) The only difference between the 0/1 Knapsack problem and this problem is that we are allowed
