...
Note: Eagerly assigning works. Because we start from node1 and nothing is colored before that. 
If the requirement change into some are colored and some are not colored, then we need backtrack.
================================================Data Flow Analysis================================================
Input: N = 4, dislikes = [[1,2],[1,3],[2,4]]
