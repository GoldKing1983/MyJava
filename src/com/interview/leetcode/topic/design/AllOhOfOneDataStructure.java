...
===========================================================Requirement===========================================================
Design a data structure to store the strings(keys) count with the ability to return the strings with minimum and maximum counts.
Ex: 
Inc("hello")
Inc("hello")
Inc("hello") 
Inc("world")
GetMaxKey() --> return hello
GetMinKey() --> return world
...
1) hashMap key is key(string) itself, value is doubleLinkedList.
