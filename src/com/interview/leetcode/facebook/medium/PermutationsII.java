...
https://leetcode.com/problems/permutations-ii/
 ...
 1) k > 0--> don't check for 0th element. Because we compare current and previous index of previous combo
 2) if value at current and previous combo is same then break.
============
 This problem is simpler than SubsetsII.
 In subsetsII, we need to maintain lastcount, if current and previous duplicate,
 do operation from lastCount to n.
 */
